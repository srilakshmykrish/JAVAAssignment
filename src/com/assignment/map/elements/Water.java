...
/** Map element Water creates a constructor with parameters x and y and sets the row of the map xValue and column as yValue.
...
public class Water implements Node
{
    ...
    /** Method getNodeElements is used to return the representation of each map elements. Say Water as W.
     * @return W
     */
    @Override
    ...
    /** Method getnodeName is used to return the representation of each map elements. Say Water as WATER.
     * @return WATER
     */
    @Override
