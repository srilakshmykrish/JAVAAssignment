...
/** Map element Start creates a constructor with parameters x and y and sets the row of the map xValue and column as yValue.
...
public class Start implements Node
{
    ...
    /** Method getNodeElement is used to return the representation of each map elements. Say Start as S.
     * @return S
     */
    @Override
    ...
    /** Method getnodeName is used to return the representation of each map elements. Say Start as START.
     * @return START
     */
    @Override
